...
- shell script syntax under `tools/validation/` (and conditionally under `scripts/` when that directory exists, to catch release-script regressions in full checkouts)
